                ...
                <div className="row gap-5 gap-lg-0 ">
                    <div className={`col-lg-6 order-2 order-lg-1    ${styles["img-col"]}`}>
                        <div className="row d-flex justify-content-center">
                            <div className={`col-lg-7 col-9 h-100 b d-flex`}>
                    ...
                    <div className={`col-lg-6 d-flex order-1 order-lg-2 flex-column justify-content-center align-items-start px-5  ${styles["text-col"]}`}>
                        ...
                        <div className="d-flex flex-column flex-sm-row justify-content-around w-100 mt-4 p-3">
                            <div className="d-flex flex-column align-items-center">
                                <p className="text-white fs-4 fw-bold m-0">Fast Delivery</p>
                                <p className="text-white text-opacity-75">Order Now</p>
                            </div>
                            <div className="d-flex flex-column align-items-center">
                                <p className="text-white fs-4 fw-bold m-0">Quality Assurance</p>
                                <p className="text-white text-opacity-75">With Certificates</p>
                            </div>
                            <div className="d-flex flex-column align-items-center">
                                <p className="text-white fs-4 fw-bold m-0">24/7 Support</p>
